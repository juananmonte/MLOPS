...
if __name__=="__main__":
    ...
    alpha = float(sys.argv[1]) if len(sys.argv) > 1 else 0.5 #sys.argv[1]  = get the first argument given
    ...
    with mlflow.start_run():
        ...
        remote_server_uri="http://ec2-52-91-191-173.compute-1.amazonaws.com/5000/"
